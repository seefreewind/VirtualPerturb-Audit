...
notes: Do not use GEARS-provided splits as final audit splits without independent leakage diagnostics. Official Dataverse datafile URL returned AWS WAF challenge to command-line access on 2026-08-12; LUH Seafile mirror was used as a reproducible fallback and the local checksum is recorded above.
```
